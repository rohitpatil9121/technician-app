...
// import Earnings from "./screens/Earnings.jsx"; // hidden for now — re-enable with the /earnings route + BottomNav link
...
export default function App() {
  ...
  return (
    <Routes>
      ...
      {/* Earnings hidden for now — re-enable this route + the BottomNav link:
      <Route path="/earnings" element={<Tabbed><Earnings /></Tabbed>} /> */}
